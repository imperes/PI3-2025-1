...
<div style="text-align: center; padding: 10px;">
  <img src="../img/esquematico- motorista.jpg" width="70%" alt="Esquemático Elétrico Motorista">
</div>

## Esquemático Elétrico - Receptor
<div style="text-align: center; padding: 10px;">
  <img src="../img/esquematico_pcb_receptor.PNG" width="70%" alt="Esquemático Elétrico Receptor">
</div>

## Esquemático Elétrico - Usuário
<div style="text-align: center; padding: 10px;">
  <img src="../img/esquematico_pcb_usuario.PNG" width="70%" alt="Esquemático Elétrico Usuário">
</div>
...
## PCB - Motorista
<div style="text-align: center; padding: 10px;">
  <img src="../img/Pcb-motorista.jpg" width="70%" alt="PCB Motorista">
</div>

## PCB - Usuário
<div style="text-align: center; padding: 10px;">
  <img src="../img/Pcb-usuario.jpg" width="70%" alt="PCB Usuário">
</div>
...
## Placa - Motorista
<div style="text-align: center; padding: 10px;">
  <img src="../img/placa-motorista.jpg" width="70%" alt="Placa Motorista">
</div>

## Placa - Usuário
<div style="text-align: center; padding: 10px;">
  <img src="../img/placa-usuario.jpg" width="70%" alt="Placa Usuário">
</div>
